...
<br>  
<h2>☑レベルアップ</h2>
高校生はテストの点数やInstagramのいいねの数など些細なことから大きなことまで、様々なことで自分が優位に立っていたいという姿が顕著に表れており頻繁に周りと比べることをします。この性質を上手く利用できないかと思いついたのがこの機能です。comment（質問）、response（回答） diary（学習の記録）を１つ投稿することで１ポイントが生徒に付与されます。そのポイントを貯めることで生徒のレベルが上がっていきます。生徒はレベルを上げようと、日々多くのcomment（質問）、response（回答）をするようになると考えています。
